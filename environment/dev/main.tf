module "EKS-BASE-CONTROL-PLANE" {
  source = "git::https://github.com/KIngnafa/eks_deployments.git//MODULES/EKS-BASE-1/controlplane"
...
module "EKS-BASE-DATA-PLANE" {
  source = "git::https://github.com/KIngnafa/eks_deployments.git//MODULES/EKS-BASE-1/dataplane/nodes"
...
module "VPC-BASE" {
  source = "git::https://github.com/KIngnafa/eks_deployments.git//MODULES/VPC-BASE"
